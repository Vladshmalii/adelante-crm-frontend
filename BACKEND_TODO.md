...
Весь backend код повинен бути створений з нуля згідно з цією специфікацією.
...
- Всі API endpoints описані в `BACKEND_API_SPEC.md`
- Детальна специфікація реалізації в `BACKEND_PYTHON_SPEC.md`
- Frontend використовує mock дані, потрібно замінити на реальні API виклики
