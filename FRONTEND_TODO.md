...
#### 3.1 Страница логина
- [x] Создать `/app/login/page.tsx`
- [x] Форма логина (email, password)
- [x] Валидация полей
- [x] Обработка ошибок
- [x] Redirect после успешного входа
...
#### 3.3 Страница восстановления пароля
- [x] Создать `/app/forgot-password/page.tsx`
- [x] Форма с email
- [x] Отправка ссылки на email (фронтенд-часть, без интеграції з API)
- [x] Страница сброса пароля `/app/reset-password/page.tsx`
...
- [x] Дизайн кнопки/блока входа через Telegram
...
#### 4.1 Компонент Toast
- [x] Создать `src/shared/components/ui/Toast.tsx`
- [x] Типы: success, error, warning, info
- [x] Автоматическое закрытие (настраиваемое)
- [x] Кнопка закрытия
- [x] Анимация появления/исчезновения
- [x] Позиция (top-right по умолчанию)
- [x] Стек уведомлений

#### 4.2 Toast Provider
- [x] Создать `src/shared/providers/ToastProvider.tsx`
- [x] Context для управления toast
...
- [x] `toast.warning(message)`
- [x] `toast.info(message)`
- [x] `toast.custom(message, options)`

#### 4.4 Интеграция
 - [x] Показывать toast при успешных операциях (форми авторизації та відновлення пароля)
 - [x] Показывать toast при ошибках API/валидации (повідомлення про помилки валідації на формах)

---

### 5. Недостающие UI компоненты

#### 5.1 Skeleton.tsx
- [x] Создать `src/shared/components/ui/Skeleton.tsx`
- [x] Варианты: text, circle, rectangle
- [x] Анимация пульсации
- [x] Использовать при загрузке данных

#### 5.2 Pagination.tsx
- [x] Создать `src/shared/components/ui/Pagination.tsx`
- [x] Кнопки prev/next
- [x] Номера страниц
- [x] Выбор количества элементов на странице
- [x] Информация о текущей странице
...
#### 5.4 FileUpload.tsx
- [x] Создать `src/shared/components/ui/FileUpload.tsx`
- [x] Drag & drop
- [x] Превью изображений
- [x] Прогресс загрузки
- [x] Валидация типов и размера

#### 5.5 Avatar.tsx
- [x] Создать `src/shared/components/ui/Avatar.tsx`
- [x] Отображение изображения
- [x] Fallback на инициалы
- [x] Размеры: sm, md, lg
- [x] Статус (online/offline)

#### 5.6 Progress.tsx
- [x] Создать `src/shared/components/ui/Progress.tsx`
- [x] Линейный прогресс
- [x] Круговой прогресс
- [x] Проценты
- [x] Цвета
...
#### 5.7 Switch.tsx
- [x] Создать `src/shared/components/ui/Switch.tsx`
- [x] Toggle переключатель
- [x] Размеры
...
- [x] Checked/unchecked
- [x] Indeterminate состояние
- [x] Disabled состояние

#### 5.9 Radio.tsx
- [x] Создать `src/shared/components/ui/Radio.tsx`
- [x] Radio группа
- [x] Disabled состояние

#### 5.10 Breadcrumbs.tsx
- [x] Создать `src/shared/components/ui/Breadcrumbs.tsx`
- [x] Навигационные крошки
- [x] Автоматическая генерация из роута

---

## 🟡 Средний приоритет (Важно для полноценной работы)
#### 6.1 Финансы
- [x] `EditOperationModal.tsx`
- [x] `CreateDocumentModal.tsx`
- [x] `EditDocumentModal.tsx`
- [x] `DocumentDetailsModal.tsx`
- [x] `CreateReceiptModal.tsx`
- [x] `EditReceiptModal.tsx`
- [x] `ReceiptDetailsModal.tsx`
- [x] `EditPaymentMethodModal.tsx`
- [x] `CreateCashRegisterModal.tsx`
- [x] `EditCashRegisterModal.tsx`
#### 6.3 Сотрудники
- [ ] `StaffScheduleModal.tsx` - график работы
- [ ] `StaffStatisticsModal.tsx` - статистика
...
### 10. Улучшение существующих компонентов
...
#### 10.2 DatePicker
- [ ] Добавить выбор диапазона дат
- [ ] Добавить быстрые фильтры (сегодня, неделя, месяц)
- [ ] Улучшить мобильную версию

#### 10.3 Modal
- [ ] Добавить размеры (xs, sm, md, lg, xl, full)
...
#### 11.1 Error Boundary
- [ ] Создать `src/shared/components/ErrorBoundary.tsx`
- [ ] Отлов ошибок React
...
#### 12.1 Глобальный loader
- [ ] Создать `src/shared/components/GlobalLoader.tsx`
- [ ] Показывать при навигации
- [ ] Показывать при загрузке данных

#### 12.2 Skeleton screens
- [ ] Использовать Skeleton вместо Loader
- [ ] Создать скелетоны для каждого модуля:
  - CalendarSkeleton
...
#### 15.1 Страница отчетов
- [ ] Создать `/app/reports/page.tsx`
- [ ] Выбор типа отчета
- [ ] Фильтры по датам
- [ ] Экспорт в PDF/Excel

#### 15.2 Компоненты отчетов
- [ ] `RevenueReport.tsx` - отчет по выручке
- [ ] `StaffPerformanceReport.tsx` - эффективность сотрудников
- [ ] `ServicesPopularityReport.tsx` - популярность услуг
- [ ] `ClientsReport.tsx` - отчет по клиентам
