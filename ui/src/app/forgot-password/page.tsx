                ...
                <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary to-primary/80 text-primary-foreground p-8 relative">
                    ...
                    <div className="relative space-y-4">
                        ...
                        <p className="text-sm text-primary-foreground/90 max-w-sm">
                            Відновіть доступ до панелі керування салоном. Посилання для скидання
                            пароля буде надіслано на вашу пошту.
                        </p>
                    </div>
                    ...
                    <div className="w-full max-w-sm space-y-6">
                        <div className="space-y-2 text-center lg:text-left">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Введіть email, з яким ви входите в систему. Ми надішлемо інструкцію
                                для скидання пароля.
                            </p>
                        </div>
                        ...
                        {submitted ? (
                            <div className="space-y-3 rounded-lg border border-emerald-500/40 bg-emerald-500/5 px-4 py-3 text-sm">
                                ...
                                <p className="text-muted-foreground">
                                    Якщо лист не з&apos;явився протягом декількох хвилин, перевірте
                                    папку &quot;Спам&quot; або спробуйте ще раз.
                                </p>
                                <a
                                    href="/login"
