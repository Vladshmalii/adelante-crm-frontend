...
import type {
    ...
    Review,
    Change,
    RecordsFilters as RecordsFiltersType,
    ReviewsFilters as ReviewsFiltersType,
    ChangesFilters as ChangesFiltersType,
...
function OverviewContent() {
    ...
    const { records } = useOverviewRecords(recordsFilters);
    const { reviews } = useOverviewReviews(reviewsFilters);
    const { changes } = useOverviewChanges(changesFilters);
            ...
            {activeTab === 'records' && (
                <div className="flex flex-col h-full min-h-0 mt-4">
                    <div className="flex-1 overflow-y-auto px-6 pb-10 custom-scrollbar">
                        ...
                        />
                        <RecordsTable records={records} onView={handleViewRecord} />
                    </div>
                </div>
            )}
            ...
            {activeTab === 'reviews' && (
                <div className="flex flex-col h-full min-h-0 mt-4">
                    <div className="flex-1 overflow-y-auto px-6 pb-10 custom-scrollbar">
                        ...
                        />
                        <ReviewsList reviews={reviews} onView={handleViewReview} />
                    </div>
                </div>
            )}
            ...
            {activeTab === 'changes' && (
                <div className="flex flex-col h-full min-h-0 mt-4">
                    <div className="flex-1 overflow-y-auto px-6 pb-10 custom-scrollbar">
                        ...
                        />
                        <ChangesTable changes={changes} onView={handleViewChange} />
                    </div>
                </div>
            )}
