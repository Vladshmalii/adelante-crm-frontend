...
function OverviewContent() {
    ...
    return (
        <div className="flex h-[calc(100vh-140px)] min-h-0 flex-col">
            ...
            {activeTab === 'records' && (
                <div className="mt-4 flex h-full min-h-0 flex-col">
                    <div className="custom-scrollbar flex-1 overflow-y-auto px-6 pb-10">
                        ...
                        />
                        <RecordsTable records={MOCK_RECORDS} onView={handleViewRecord} />
                    </div>
                </div>
            )}
            ...
            {activeTab === 'reviews' && (
                <div className="mt-4 flex h-full min-h-0 flex-col">
                    <div className="custom-scrollbar flex-1 overflow-y-auto px-6 pb-10">
                        ...
                        />
                        <ReviewsList reviews={MOCK_REVIEWS} onView={handleViewReview} />
                    </div>
                </div>
            )}
            ...
            {activeTab === 'changes' && (
                <div className="mt-4 flex h-full min-h-0 flex-col">
                    <div className="custom-scrollbar flex-1 overflow-y-auto px-6 pb-10">
                        ...
                        />
                        <ChangesTable changes={MOCK_CHANGES} onView={handleViewChange} />
                    </div>
                </div>
            )}
