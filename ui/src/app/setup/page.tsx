...
// authApi.setup завжди кидає помилку (самостійне створення салону
// недоступне) і типізований як Promise<never> — це очікувана форма
// відповіді, якби бекенд колись підтримав цей флоу.
...
export default function SetupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = (await authApi.setup({ email, password })) as unknown as SetupResponse;
            ...
            console.error('[SETUP] Error constructor:', err?.constructor?.name);
