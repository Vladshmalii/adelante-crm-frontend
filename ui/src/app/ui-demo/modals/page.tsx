        ...
        <div className="mx-auto max-w-4xl space-y-12 p-8">
            ...
            <section className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <Button variant="primary" onClick={() => openConfirm('info')}>
                        Інформація
                    </Button>
                </div>
                ...
                <ConfirmDialog
                    ...
                    message={
                        confirmVariant === 'danger'
                            ? 'Цю дію не можна скасувати. Ви впевнені, що хочете видалити цей елемент?'
                            : confirmVariant === 'warning'
                              ? 'Ви впевнені, що хочете продовжити виконання цієї дії?'
            ...
            >
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            className="min-h-[100px] w-full rounded-lg border border-border bg-background px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ring"
