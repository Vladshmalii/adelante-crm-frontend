...
export default function DataDemo() {
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-12 p-8">
            <h1 className="font-heading text-3xl font-bold text-foreground">Дані та Графіки</h1>

            {/* KPI Cards */}
            <section className="space-y-6">
                <h2 className="border-b border-border pb-2 text-xl font-semibold text-foreground">
                    Картки статистики (KPI)
                </h2>
            ...
            <section className="space-y-6">
                ...
                <div className="text-center text-sm text-muted-foreground">
                    * Таблиця використовує реальний компонент <code>ClientsTable</code> з
                    демо-даними.
                </div>
            </section>
        </div>
