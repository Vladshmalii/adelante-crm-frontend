...
export default function FormsDemo() {
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-12 p-8">
            <h1 className="font-heading text-3xl font-bold text-foreground">Елементи форми</h1>
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    />
                    <Input label="Вимкнене поле" placeholder="Ввід заборонено" disabled />
                    <div>
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <Select
                        ...
                        onChange={(val) =>
                            setFormData({ ...formData, multiSelect: val as string[] })
                        }
                    />
                    <Dropdown
            ...
            <section className="space-y-6">
                ...
                <div className="space-y-4">
                    <div className="flex flex-col gap-4">
                        ...
                        />
                        <Checkbox label="Вимкнений чекбокс" checked={true} disabled />
                    </div>
                    ...
                    <div className="flex flex-col gap-4 border-t border-border pt-4">
                        ...
                        <RadioGroup>
                            ...
                            />
                            <Radio label="Вимкнена опція" name="demo-radio" disabled />
                        </RadioGroup>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 border-t border-border pt-4">
                        <div className="flex items-center gap-8">
                            <Switch
                                ...
                                onChange={(e) =>
                                    setFormData({ ...formData, switch: e.target.checked })
                                }
                            />
                            <Switch label="Вимкнено (On)" checked={true} disabled />
                            <Switch label="Вимкнено (Off)" checked={false} disabled />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="space-y-6">
                <h2 className="border-b border-border pb-2 text-xl font-semibold text-foreground">
                    Графік роботи (Складні форми)
                </h2>
                <div className="max-w-3xl space-y-6 rounded-xl border border-border bg-card p-6">
                    <div className="space-y-2">
                        <h3 className="text-lg font-bold">Графік роботи салону</h3>
                    ...
                    <div className="space-y-4">
                        <div className="mb-2 grid grid-cols-[1fr,auto,1fr,1fr] items-center gap-4 text-sm font-medium text-muted-foreground">
                            <div>День</div>
                            <div>Відкрито</div>
                            <div>З</div>
                            <div>До</div>
                        ...
                        {[
                            ...
                            return (
                                <div
                                    key={day}
                                    className="grid grid-cols-[1fr,auto,1fr,1fr] items-center gap-4"
                                >
