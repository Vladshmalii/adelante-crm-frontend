...
function ColorSwatch({
    ...
    return (
        <div className="flex flex-col gap-2">
            <div
                ref={ref}
                className={`flex h-24 w-full flex-col items-center justify-center rounded-lg shadow-sm ${className}`}
            >
                <span className={`font-mono text-sm font-medium ${textClassName}`}>{name}</span>
                <span className={`mt-1 text-xs opacity-80 ${textClassName}`}>{hex}</span>
            </div>
...
export default function ColorsDemo() {
    return (
        <div className="mx-auto max-w-4xl space-y-12 p-8">
            <h1 className="font-heading text-3xl font-bold text-foreground">Color Palette</h1>
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
                    ...
                    <ColorSwatch
                        name="bg-destructive-foreground"
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
                    <ColorSwatch
                        ...
                        textClassName="text-foreground border border-border"
                    />
                    <ColorSwatch
                        name="bg-foreground"
                    ...
                    <ColorSwatch
                        name="bg-card"
                        className="bg-card"
                        textClassName="text-card-foreground border border-border"
                    />
                    <ColorSwatch
