...
export default function LoyaltyDemoPage() {
    ...
    return (
        <div className="space-y-6 p-6">
            <div>
                <h1 className="mb-2 text-2xl font-bold text-foreground">Модуль лояльності</h1>
            ...
            <div className="space-y-6 rounded-xl border border-border bg-card p-6">
                ...
                <div className="mt-6">
                    {activeTab === 'bonuses' && (
                        <BonusesView searchQuery={searchQuery} onEdit={handleEditBonus} />
                    )}
                    {activeTab === 'discounts' && (
                        <DiscountsView searchQuery={searchQuery} onEdit={handleEditDiscount} />
                    )}
                    {activeTab === 'certificates' && <CertificatesView searchQuery={searchQuery} />}
