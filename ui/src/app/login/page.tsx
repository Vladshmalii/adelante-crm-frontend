...
export default function LoginPage() {
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-background via-background to-accent/20 flex items-center justify-center px-4 py-8"
            suppressHydrationWarning
        >
            <div
                className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-[1.1fr,1fr] bg-card border border-border rounded-3xl shadow-2xl shadow-black/10 overflow-hidden"
                suppressHydrationWarning
            >
                <div
                    className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary to-primary/80 text-primary-foreground p-8 relative"
                    suppressHydrationWarning
                >
                    <div
