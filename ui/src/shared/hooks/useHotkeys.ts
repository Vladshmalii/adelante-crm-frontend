...
export function useHotkeys(keys: KeyCombo, callback: Handler, deps: unknown[] = []) {
    ...
    useEffect(() => {
        ...
        // deps is an arbitrary caller-supplied array by design (extra re-bind triggers
        // beyond `keys`); ESLint can't statically verify a spread dependency array.
