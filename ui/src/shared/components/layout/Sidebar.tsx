    ...
    return (
        ...
        >
            <div className="h-16 flex items-center justify-between px-4 border-b border-sidebar-border">
                <div
                    className="flex items-center gap-2 overflow-hidden transition-all duration-300 min-w-0"
                    style={{
            ...
            <div className="px-2 mt-4 mb-2">
                ...
                >
                    <Plus
                        className={clsx(
                            'w-4 h-4 flex-shrink-0 transition-transform duration-200 group-hover:rotate-90',
                        )}
                    />
                    <span
