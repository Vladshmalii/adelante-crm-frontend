...
export function TimePicker({
    ...
    const dropdown = (
        <div
            ...
            className="animate-in fade-in zoom-in-95 fixed z-[9999] rounded-lg border border-border bg-card shadow-lg duration-100"
            style={{ top: coords.top, left: coords.left, width: coords.width }}
        >
            <div className="grid max-h-64 grid-cols-2 divide-x divide-border overflow-y-auto">
                <div className="py-2">
        ...
        <div className="space-y-1.5">
            ...
            <div className="relative">
                ...
                <button
                    ...
                    disabled={disabled}
                    className={clsx(
                        'flex w-full items-center justify-between gap-2 rounded-lg border bg-background py-2 pl-9 pr-3 text-sm transition-colors',
                        error ? 'border-destructive' : 'border-border hover:border-primary/50',
                        isOpen && 'border-transparent ring-2 ring-ring',
