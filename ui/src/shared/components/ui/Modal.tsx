    ...
    return (
        <div
            className={clsx(
                ...
                position === 'center'
                    ? 'items-end sm:items-center justify-center sm:p-4 animate-fade-in'
            ...
            <div
                className={clsx(
                    ...
                    ],
                    {
                        ...
                        'sm:max-w-none sm:h-screen sm:max-h-screen sm:rounded-none sm:border-0':
                            size === 'full',
                    },
                )}
            >
                ...
                <div className={clsx('overflow-y-auto custom-scrollbar flex-1 p-5 sm:p-7')}>
                    {children}
                </div>
