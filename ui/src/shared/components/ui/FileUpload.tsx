...
export function FileUpload({
    ...
    return (
        <div className={clsx('w-full', className)}>
            ...
            {(error || uploadError) && (
                <p className="mt-1.5 animate-fade-in text-sm text-destructive">
                    {error || uploadError}
                </p>
            )}
            ...
            {files.length > 0 && (
                <div className="mt-4 space-y-2">
                    {files.map((file, index) => (
                        <div
                            key={index}
                            className="flex animate-fade-in items-center gap-3 rounded-lg border border-border bg-accent/5 p-3"
                        >
