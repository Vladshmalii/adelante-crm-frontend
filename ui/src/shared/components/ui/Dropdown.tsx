...
interface DropdownProps<V extends string | number | (string | number)[]> {
    label?: string;
    placeholder?: string;
    value: V;
...
export function Dropdown<V extends string | number | (string | number)[] = string | number>({
    label,
    placeholder = 'Оберіть...',
    value,
    options,
    ...
    }, [searchable, grouping, filteredOptions]);
    ...
    }, [isOpen, searchable, label, updatePosition]);
    ...
    }, [isOpen, grouping, collapsible, groupedOptions]);
