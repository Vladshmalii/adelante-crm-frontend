...
/**
 * Backend сериализует Decimal-поля (гроші, знижки) як рядок ("1200.00"),
 * щоб не втрачати точність у JSON. Використовуйте це при мапінгу
 * відповідей API на фронтові типи, де такі поля оголошені як number.
 */
