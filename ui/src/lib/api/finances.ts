...
export const financesApi = {
    ...
    createOperation: async (
        data: Omit<FinanceOperation, 'id' | 'createdAt' | 'updatedAt'>,
    ...
    createDocument: async (
        data: Omit<FinanceDocument, 'id' | 'createdAt' | 'updatedAt'>,
    ): Promise<FinanceDocument> => {
    ...
    getCashRegisters: async (): Promise<
        Array<{ id: number; name: string; balance: number; isActive: boolean }>
    > => {
