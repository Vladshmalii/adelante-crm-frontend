        ...
        >
            <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                    <h3 className="text-[15px] font-bold text-foreground mb-1 group-hover:text-primary transition-colors">
                        {review.clientName}
                    </h3>
            ...
            <div className="flex items-center gap-4 text-[12px] text-muted-foreground mb-4 font-medium">
                <span className="flex items-center gap-1.5 bg-secondary/20 px-2 py-0.5 rounded-md">
                    {review.phone}
                </span>
