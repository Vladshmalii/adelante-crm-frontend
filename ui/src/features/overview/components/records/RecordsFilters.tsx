        ...
        <div className="p-5 rounded-2xl bg-secondary/30 border border-border/50 mb-6 mx-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Dropdown
                    ...
                    onChange={(value) =>
                        updateFilter('visitStatus', value as Filters['visitStatus'])
                    }
                />
                <Dropdown
                    label="Статус оплати"
                    ...
                    onChange={(value) =>
                        updateFilter('paymentStatus', value as Filters['paymentStatus'])
                    }
                />
                <Dropdown
                    ...
                    onChange={(value) => updateFilter('source', value as Filters['source'])}
                />
