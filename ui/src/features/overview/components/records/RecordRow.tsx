...
export function RecordRow({ record, isEven: _isEven, onView }: RecordRowProps) {
    ...
    return (
        <tr className="border-b border-border/50 transition-all duration-300 hover:bg-primary/[0.02]">
            ...
            <td className="px-4 py-4">
                <span className="text-sm font-bold text-foreground">{record.employee}</span>
            </td>
            <td className="px-4 py-4">
                <span className="text-sm font-medium text-foreground/80">{record.service}</span>
            </td>
            <td className="px-4 py-4">
                <div className="flex flex-col">
                    <span className="text-sm font-bold text-foreground">{record.client}</span>
            ...
            <td className="px-4 py-4 text-sm text-foreground/70">{record.createdBy}</td>
            ...
            <td className="px-4 py-4">
                <Badge
                    variant="secondary"
                    className="bg-secondary text-foreground/70 border-none font-bold text-[10px] uppercase"
                >
