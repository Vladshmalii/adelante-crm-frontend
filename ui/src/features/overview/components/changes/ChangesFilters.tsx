    ...
    return (
        <div className="mx-4 mb-6 rounded-2xl border border-border/50 bg-secondary/30 p-5">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                />
                <div className="mt-2 flex justify-end lg:col-span-4">
                    <Button
                        variant="primary"
                        className="h-[42px] rounded-xl px-8 font-bold shadow-lg shadow-primary/10 transition-all active:scale-95"
                    >
                        Показати зміни
                    </Button>
                </div>
