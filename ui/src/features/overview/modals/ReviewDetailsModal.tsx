...
import { Star, User, Phone, Calendar, MessageSquare, Quote, MessageCircle } from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-secondary/10 rounded-2xl border border-border/50">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="text-[11px] font-black uppercase tracking-widest text-muted-foreground/60 leading-none mb-1.5">
                                Клієнт
                            </div>
                    ...
                    <div className="flex flex-col items-end">
                        <div className="text-[11px] font-black uppercase tracking-widest text-muted-foreground/60 mb-2">
                            Рейтинг
                        </div>
                        <div className="flex items-center gap-1 bg-background px-3 py-1.5 rounded-xl border border-border/50 shadow-sm">
                            <span className="text-sm font-black text-foreground mr-1">
                                {review.rating}.0
                            </span>
                ...
                <div className="space-y-3">
                    <div className="text-[11px] font-black uppercase tracking-widest text-muted-foreground/60 px-1">
                        Зв&apos;язок з клієнтом
                    </div>
                    <div className="flex gap-3">
                        <Button
                            variant="secondary"
                            className="flex-1 gap-2 rounded-xl h-12 text-sm font-bold"
                        >
