...
interface AddRecordModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (data: AddRecordFormData) => void;
}

export function AddRecordModal({ isOpen, onClose, onSave }: AddRecordModalProps) {
    const toast = useToast();

    const [formData, setFormData] = useState<AddRecordFormData>({
        employee: '',
        service: '',
        client: '',
        phone: '',
    ...
    const handleChange = <K extends keyof AddRecordFormData>(
        field: K,
        value: AddRecordFormData[K],
    ) => {
