...
export function CreateCertificateModal({ isOpen, onClose, onSave }: CreateCertificateModalProps) {
    ...
    const amountOptions = [...CERTIFICATE_AMOUNTS, { value: 'custom', label: 'Інша сума' }];
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Новий сертифікат" size="sm">
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-4">
                    <label className="block text-sm font-medium text-foreground">Номінал</label>
