    ...
    if (filteredDiscounts.length === 0) {
        return (
            <EmptyState
                ...
                description={
                    searchQuery ? 'Спробуйте змінити параметри пошуку' : 'Створіть першу знижку'
                }
            />
        );
    }
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filteredDiscounts.map((discount) => {
                ...
                return (
                    <Card key={discount.id} className="p-5 transition-shadow hover:shadow-md">
                            ...
                            <div className="min-w-0 flex-1 pr-4">
                                ...
                                {discount.code && (
                                    <button
                                        ...
                                        className="group mt-1.5 flex items-center gap-1.5 text-sm text-primary transition-colors hover:text-primary-hover"
                                    >
                                        <code className="rounded bg-primary/10 px-2 py-0.5 font-mono">
                                            {discount.code}
                                        </code>
                                        <Copy
                                            size={14}
                        ...
                        <div className="flex items-center gap-2 border-t border-border pt-3">
                            ...
                            >
                                <span className="hidden sm:inline">
                                    {discount.isActive ? 'Активна' : 'Увімкнути'}
                                </span>
                            </Button>
