...
export function ClientBonusesView({ searchQuery }: ClientBonusesViewProps) {
    const filteredClients = useMemo(() => {
        ...
        return mockClientBonuses.filter((client) =>
            ...
            <EmptyState
                ...
                description={
                    searchQuery
                        ...
                        : 'Клієнти з бонусами зʼявляться тут'
                }
            />
        );
    }
                    ...
                    return (
                        <Card key={key} className="p-4">
                            <div className="flex items-center gap-3">
                                <div
                                    className={`h-10 w-10 rounded-full ${level.color} flex items-center justify-center`}
                                >
                            ...
                            {filteredClients.map((client) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            <span
                                                className={`inline-flex items-center rounded-full px-2.5 py-1 text-sm font-medium ${levelInfo.color} text-white`}
                                            >
                                                {levelInfo.name}
                                            </span>
                                        </td>
                                        <td className="p-4 text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                <span className="font-medium">
                                                    {client.totalPoints.toLocaleString()}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="p-4 text-right">
