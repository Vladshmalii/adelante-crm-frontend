                    ...
                    return (
                        <Card key={key} className="p-4">
                            <div className="flex items-center gap-3">
                                <div
                                    className={`w-10 h-10 rounded-full ${level.color} flex items-center justify-center`}
                                >
                            ...
                            {filteredClients.map((client) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            <span
                                                className={`inline-flex items-center px-2.5 py-1 rounded-full text-sm font-medium ${levelInfo.color} text-white`}
                                            >
                                                {levelInfo.name}
                                            </span>
                                        </td>
