                    ...
                    <div className="space-y-3">
                        <div className="p-3 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                            <Checkbox
                                ...
                                onChange={() => handleToggle('includeBasicInfo')}
                            />
                        ...
                        <div className="p-3 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                            <Checkbox
                                ...
                                onChange={() => handleToggle('includeStockInfo')}
                            />
                            <p className="text-xs text-muted-foreground mt-1 ml-7">
                        ...
                        <div className="p-3 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                            <Checkbox
                                ...
                                onChange={() => handleToggle('includeFinancialInfo')}
                            />
                            <p className="text-xs text-muted-foreground mt-1 ml-7">
                        ...
                        <div className="p-3 rounded-lg border border-border hover:bg-secondary/50 transition-colors">
                            <Checkbox
                                ...
                                onChange={() => handleToggle('includeDescription')}
                            />
                            <p className="text-xs text-muted-foreground mt-1 ml-7">
