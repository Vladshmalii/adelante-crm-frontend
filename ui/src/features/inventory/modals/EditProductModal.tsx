...
import { Product, AddProductFormData, ProductCategory, ProductUnit } from '../types';
...
export function EditProductModal({ isOpen, onClose, onSave, product }: EditProductModalProps) {
    ...
    const handleChange = <K extends keyof AddProductFormData>(
        field: K,
        value: AddProductFormData[K],
    ) => {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                    <Dropdown
                        ...
                        options={categories}
                        onChange={(val) =>
                            handleChange('category', val as AddProductFormData['category'])
                        }
                    />
                </div>
                ...
                <div className="p-4 bg-muted/30 rounded-lg border border-border">
                    ...
                    >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex items-center bg-background border border-border rounded-xl p-1 h-[42px] focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
                                    <input
                                        ...
                                        className="flex-1 bg-transparent text-center font-bold text-sm text-foreground focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                    />
                                </div>
                            </div>
                        )}
                        <div className="space-y-1.5">
                            <label className="text-sm font-medium text-foreground truncate">
                                Поточний залишок ({formData.unit})
                            </label>
                            <div className="flex items-center bg-background border border-border rounded-xl p-1 h-[42px] focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
                                <button
                                    type="button"
                                    ...
                                    className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-muted text-muted-foreground hover:text-primary transition-all"
                                >
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Dropdown
                                ...
                                onChange={(val) =>
                                    handleChange('unit', val as AddProductFormData['unit'])
                                }
