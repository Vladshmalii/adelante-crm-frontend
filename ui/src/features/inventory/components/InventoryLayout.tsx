...
import {
    Product,
    InventoryFilters as FilterType,
    AddProductFormData,
...
export function InventoryLayout() {
    ...
    const handleAddProduct = async (data: AddProductFormData) => {
        try {
            ...
            toast.error(
                'Помилка',
                err instanceof Error ? err.message : 'Не вдалося створити товар',
            );
        }
    };
    ...
    const handleDeleteProduct = async () => {
        ...
        try {
            ...
            toast.error(
                'Помилка',
                err instanceof Error ? err.message : 'Не вдалося видалити товар',
            );
        }
    };
    ...
    const handleStockMovement = async (data: StockMovementFormData) => {
        try {
            ...
            toast.error(
                'Помилка',
                err instanceof Error ? err.message : 'Не вдалося оновити рух по складу',
            );
        }
    };
