...
export function InventoryFilters({ filters, onFiltersChange }: InventoryFiltersProps) {
    ...
    const handleChange = <K extends keyof FilterType>(key: K, value: FilterType[K]) => {
        ...
        <div className="p-5 rounded-2xl bg-secondary/30 border border-border/50 mb-6 mx-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <Dropdown
                    ...
                    onChange={(val) => handleChange('category', val as FilterType['category'])}
                />
                ...
                <Dropdown
                    ...
                    onChange={(val) =>
                        handleChange('stockStatus', val as FilterType['stockStatus'])
                    }
                />
            </div>
        </div>
