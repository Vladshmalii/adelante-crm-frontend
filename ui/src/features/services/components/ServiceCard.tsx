        ...
        >
            ...
            <div className="flex items-start justify-between mb-2.5 relative z-10">
                ...
                <Badge
                    ...
                    className="font-black uppercase text-[8px] px-1.5 py-0.5 tracking-wider shadow-sm"
                >
            ...
            <div className="flex-1 relative z-10">
                <div className="flex items-center gap-2 mb-1">
                    <Badge
                        variant="default"
                        className="bg-secondary/80 text-muted-foreground font-bold text-[8px] uppercase px-1.5 py-0.5 rounded-md"
                    >
