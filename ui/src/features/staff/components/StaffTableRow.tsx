    ...
    return (
        ...
        >
            ...
            <td className="hidden px-4 py-4 md:table-cell">
                <Badge
                    variant="primary"
                    className="border-none bg-primary/10 text-[10px] font-bold uppercase tracking-wider text-primary"
                >
            ...
            <td className="hidden px-4 py-4 text-center text-sm font-bold text-foreground xl:table-cell">
                {staff.commission}%
            </td>
