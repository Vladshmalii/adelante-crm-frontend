    ...
    return (
        ...
        >
            ...
            <td className="px-4 py-4 hidden md:table-cell">
                <Badge
                    variant="primary"
                    className="bg-primary/10 text-primary border-none font-bold uppercase text-[10px] tracking-wider"
                >
            ...
            <td className="px-4 py-4 text-sm font-bold text-foreground hidden xl:table-cell text-center">
                {staff.commission}%
            </td>
