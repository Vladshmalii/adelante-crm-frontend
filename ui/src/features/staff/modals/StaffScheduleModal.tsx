...
export function StaffScheduleModal({ isOpen, onClose, staff, onSave }: StaffScheduleModalProps) {
    ...
    const TimeInput = ({
        ...
        <input
            ...
            disabled={disabled}
            className="rounded-lg border border-border bg-input px-2 py-1.5 text-sm text-foreground focus:border-transparent focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
        />
    );
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <TimeInput
                                                    value={day.startTime}
                                                    onChange={(val) =>
                                                        handleDayChange(dayKey, 'startTime', val)
                                                    }
                                                />
                                                ...
                                                <TimeInput
                                                    value={day.endTime}
                                                    onChange={(val) =>
                                                        handleDayChange(dayKey, 'endTime', val)
                                                    }
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <TimeInput
                                                    ...
                                                    onChange={(val) =>
                                                        handleDayChange(dayKey, 'breakStart', val)
                                                    }
                                                />
                                                <span className="text-muted-foreground">—</span>
                                                <TimeInput
                                                    value={day.breakEnd || ''}
                                                    onChange={(val) =>
                                                        handleDayChange(dayKey, 'breakEnd', val)
                                                    }
                                                />
                                            </div>
                                        </div>
