...
import { Calendar, Clock, User, Check, ArrowLeft, ArrowRight, type LucideIcon } from 'lucide-react';
...
const steps: { id: BookingStep; label: string; icon: LucideIcon }[] = [
        ...
        >
            <div className="max-w-3xl mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-foreground mb-2">Онлайн запис</h1>
