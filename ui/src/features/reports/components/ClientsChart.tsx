        ...
        <Card className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="p-4 bg-primary/5 rounded-xl">
                    ...
                    <div
                        className={`flex items-center gap-1 text-xs mt-1 ${newClientsChange >= 0 ? 'text-green-600' : 'text-red-600'}`}
                    >
                        {newClientsChange >= 0 ? (
                ...
                <div className="p-4 bg-green-500/5 rounded-xl">
                    ...
                    <div
                        className={`flex items-center gap-1 text-xs mt-1 ${returningChange >= 0 ? 'text-green-600' : 'text-red-600'}`}
                    >
                        {returningChange >= 0 ? (
                            <TrendingUp className="w-3 h-3" />
                        ) : (
