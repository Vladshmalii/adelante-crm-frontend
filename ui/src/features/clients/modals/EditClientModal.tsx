...
export function EditClientModal({ isOpen, onClose, onSave, client }: EditClientModalProps) {
    ...
    useEffect(() => {
        if (client) {
            setFormData({
                ...
                gender: (client.gender as ClientGender) || 'female',
                importance: (client.importance as ClientImportance) || 'medium',
                discount: client.discount || 0,
                colorLabel: client.color || COLOR_LABELS[0],
                noOnlineBooking: client.noOnlineBooking || false,
    ...
    const handleChange = <K extends keyof AddClientFormData>(
        field: K,
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <Dropdown
                            ...
                            options={CATEGORIES}
                            onChange={(val) => handleChange('category', val as ClientCategory)}
                        />
                    </div>
                    ...
                    <div>
                        <Dropdown
                            ...
                            options={GENDERS}
                            onChange={(val) => handleChange('gender', val as ClientGender)}
                        />
                    </div>
                    ...
                    <div>
                        <Dropdown
                            ...
                            onChange={(val) => handleChange('importance', val as ClientImportance)}
                        />
                    </div>
