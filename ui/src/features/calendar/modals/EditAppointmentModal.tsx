...
interface EditAppointmentModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (id: string, data: Partial<Appointment>) => void | Promise<void>;
...
export function EditAppointmentModal({
    ...
    const [formData, setFormData] = useState<EditAppointmentFormData>({
        staffId: '',
        clientName: '',
        clientPhone: '',
        service: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error('Помилка', err instanceof Error ? err.message : 'Не вдалося оновити запис');
        }
    };

    const handleChange = <K extends keyof EditAppointmentFormData>(
        field: K,
        value: EditAppointmentFormData[K],
    ) => {
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2">
                        <Dropdown
                            ...
                            onChange={(val) => handleChange('staffId', val as string)}
                        />
                    </div>
                    ...
                    <div>
                        <Dropdown
                            ...
                            onChange={(val) => handleChange('type', val as AppointmentType)}
                        />
                    </div>
                    ...
                    <div>
                        <Dropdown
                            ...
                            onChange={(val) => handleChange('status', val as AppointmentStatus)}
                        />
                    </div>
