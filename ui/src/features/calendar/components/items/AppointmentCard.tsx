    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className={clsx(
                        'flex items-start justify-between min-w-0 gap-2',
                        isSmall ? 'mb-0.5' : 'mb-1',
                    )}
                >
                    ...
                    {!isTiny && (
                        <div
                            className={clsx(
                                'rounded bg-background/40 border border-border/5 shrink-0 mt-0.5',
                                isSmall ? 'p-0' : 'p-0.5',
                            )}
                        >
                ...
                {!isTiny && (appointment.clientName || appointment.otherPersonName) && (
                    ...
                    >
                        <User
                            className={clsx(
                                'w-2.5 h-2.5 shrink-0 opacity-40',
                        ...
                        <div className="flex items-center gap-1 min-w-0 flex-1">
                            ...
                            >
                                ...
                                {appointment.isForAnotherPerson && (
                                    <span className="ml-0.5 text-[7px] text-amber-500/80 uppercase font-black tracking-widest">
                                        (Гість)
                                    </span>
                                )}
                            </span>
