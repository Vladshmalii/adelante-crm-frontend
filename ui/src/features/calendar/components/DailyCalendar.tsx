...
export function DailyCalendar() {
    ...
    const { staff: staffList, isLoading: staffLoading } = useStaff({ status: 'active' });
    ...
    const handleCreateAppointment = async (data: CreateAppointmentData) => {
        ...
        if (checkOverlap(staffId, data.date, data.startTime, data.endTime)) {
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 min-h-0">{calendarContent}</div>
