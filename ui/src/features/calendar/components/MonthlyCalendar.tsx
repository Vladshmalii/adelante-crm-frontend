        ...
        <div className="h-full overflow-auto p-6 bg-background scrollbar-thin">
            <div className="bg-card border border-border/10 rounded-[2rem] overflow-hidden shadow-2xl">
                ...
                {weeks.map((week, weekIndex) => (
                    <div
                        key={weekIndex}
                        className="grid grid-cols-7 border-b border-border/10 last:border-0 relative"
                    >
                        {week.map((day) => {
                            ...
                            return (
                                ...
                                >
                                    {isToday && (
                                        <div className="absolute inset-x-4 top-0 h-1 bg-primary rounded-b-full shadow-[0_0_10px_rgba(var(--primary),0.3)] z-10" />
                                    )}
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    {isToday && (
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-primary bg-primary/10 px-2 py-1 rounded-lg">
                                            Сьогодні
                                        </span>
                                    )}
                                </div>
