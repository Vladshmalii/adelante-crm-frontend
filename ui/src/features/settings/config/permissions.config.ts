...
export const PERMISSIONS_CONFIG: PermissionModuleConfig[] = [
    {
        ...
        permissions: [
            {
                id: 'appointments.view_clients_data',
                title: 'Доступ до даних клієнтів (включно з номером телефону)',
            },
            {
                id: 'appointments.create_clients',
                title: 'Доступ до створення нових клієнтів у записі',
            },
            {
                id: 'appointments.view_clients_dropdown',
                title: 'Доступ до випадаючого списку з даними про клієнтів',
            },
            ...
            { id: 'appointments.create', title: 'Створювати записи' },
            {
                ...
                children: [
                    {
                        id: 'appointments.edit.status_arrived',
                        title: 'Змінити запис зі статусом "Клієнт прийшов"',
                    },
                    {
                        id: 'appointments.edit.paid_confirmed',
                        title: 'Доступ до редагування оплачених записів зі статусом "Підтверджено"',
                    },
                    ...
                    {
                        id: 'appointments.edit.extra_fields',
                        title: 'Змінювати додаткові поля запису',
                    },
                    {
                        id: 'appointments.edit.staff_time',
                        title: 'Змінити працівника та час зустрічі',
                    },
            ...
            {
                id: 'appointments.view_network_clients',
                title: 'Доступ до даних мережевих клієнтів',
            },
        ],
    },
    {
        ...
        permissions: [
            {
                id: 'clients.list.show_contacts',
                title: 'Показувати номери телефонів та email в списку клієнтів',
            },
    ...
    },
    {
        ...
        permissions: [
            ...
            {
                id: 'loyalty.cards.manual_balance',
                title: 'Ручне поповнення / списання з карт лояльності',
            },
            { id: 'loyalty.subscriptions.edit_balance', title: 'Редагування балансу абонементів' },
            {
                id: 'loyalty.subscriptions.edit_expiry',
                title: 'Редагування терміну дії абонементів',
            },
            ...
            {
                id: 'loyalty.certificates.edit_expiry',
                title: 'Редагування терміну дії сертифікатів',
            },
            {
                id: 'loyalty.payment_without_code',
                title: 'Оплата сертифікатом і абонементом без коду',
            },
        ],
    },
    {
        ...
        permissions: [
            {
                ...
                type: 'select',
                options: [{ value: 'specific_employee', label: 'Обрати співробітника' }],
            },
            { id: 'finances.salary_accrual', title: 'Доступ до нарахування заробітної плати' },
            {
                ...
                type: 'select',
                options: [{ value: 'all_cashboxes', label: 'Обрати касу' }],
            },
        ...
        permissions: [
            {
                ...
                type: 'select',
                options: [{ value: 'all_stores', label: 'Обрати склад' }],
            },
            {
                id: 'inventory.cost.view',
                title: 'Переглянути собівартість товарів і витратних матеріалів',
            },
            {
            ...
            {
                id: 'inventory.movements.export',
                title: 'Доступ до вивантаження рухів товарів в Excel',
            },
            ...
            {
                id: 'inventory.reports.write_off_materials',
                title: 'Доступ до звіту по списанню матеріалів',
            },
            {
                id: 'inventory.reports.write_off_products',
                title: 'Доступ до звіту по списанню товарів',
            },
    ...
    },
    {
        ...
        permissions: [
            ...
            {
                id: 'settings.payment_docs.edit',
                title: 'Зміна налаштувань отримання платіжних документів',
            },
            {
                id: 'settings.client_categories.edit',
                title: 'Налаштування списку категорій клієнтів',
            },
        ],
    },
    {
