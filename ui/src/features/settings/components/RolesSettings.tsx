        ...
        <div className="mx-auto flex h-full max-w-7xl flex-col space-y-8">
            ...
            {view === 'list' && (
                <section className="rounded-lg border border-border bg-card p-6 shadow-sm">
                    <h2 className="mb-2 text-lg font-semibold">Призначення ролей співробітникам</h2>
                    <p className="mb-6 text-sm text-muted-foreground">
                        Оберіть роль для кожного співробітника, щоб надати їм відповідні права
                        доступу.
                    </p>
                        ...
                        <table className="min-w-full text-sm">
                            <thead>
                                <tr className="border-b border-border bg-muted/40 text-muted-foreground">
                                    ...
                                    <th className="w-64 px-4 py-3 text-left font-medium">
                                        Поточна роль
                                    </th>
                                </tr>
                            </thead>
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3">
                                            <Dropdown
                                                ...
                                                onChange={(value) =>
                                                    handleChangeStaffRole(String(staff.id), value)
                                                }
                                                options={roles.map((r) => ({
                                                    value: r.id,
                                                    label: r.name,
