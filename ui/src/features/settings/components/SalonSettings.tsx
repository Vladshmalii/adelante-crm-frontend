...
export function SalonSettings() {
    ...
    return (
        <div className="max-w-5xl space-y-8">
            ...
            <section className="rounded-lg border border-border bg-card p-6">
                <div className="mb-4">
                    <h2 className="mb-1 text-lg font-semibold">Графік роботи салону</h2>
                    <p className="text-sm text-muted-foreground">
                        ...
                        <tbody>
                            {WEEK_DAYS.map((day) => {
                                ...
                                return (
                                    ...
                                    >
                                        <td className="py-2 pr-4 align-middle text-foreground">
                                            {day.label}
                                        </td>
                                        ...
                                        <td className="w-28 py-2 pr-2 align-middle">
                                            <input
                                                type="time"
                                                value={config.from}
                                                onChange={(e) =>
