...
import { Role, PermissionsMap, PermissionValue } from './types';
...
export function RoleForm({ initialData, onSave, onCancel }: RoleFormProps) {
    ...
    const [permissions, setPermissions] = useState<PermissionsMap>(initialData?.permissions || {});
    const [errors, setErrors] = useState<{ name?: string }>({});

    const handlePermissionChange = (id: string, value: PermissionValue) => {
        setPermissions((prev) => ({
            ...prev,
            [id]: value,
        }));
