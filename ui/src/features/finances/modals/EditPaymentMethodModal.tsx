...
interface EditPaymentMethodModalProps {
    ...
    onSave: (data: PaymentMethod) => void | Promise<void>;
}
...
export function EditPaymentMethodModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error(
                'Помилка',
                err instanceof Error ? err.message : 'Не вдалося зберегти метод оплати',
            );
        }
    };
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={paymentMethod ? 'Редагувати метод оплати' : 'Додати метод оплати'}
            size="lg"
        >
