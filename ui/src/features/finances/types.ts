import type {
    FinanceOperation as ApiFinanceOperation,
    FinanceDocument as ApiFinanceDocument,
...
export type PaymentMethodType =
    'cash' | 'card' | 'online' | 'certificate' | 'bonus' | 'tips' | 'other';
...
export interface PaymentMethod {
    ...
    commissionPayer?: CommissionPayer | string;
